...
<html prefix="og: http://ogp.me/ns#" lang="it-IT" dir="ltr">
	<head>
		<title>Cerca - Nuovo Progetto</title>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" href="pcss/imsearch.css?2022-3-7-0-638952078921726652" media="screen,print" />
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Cerca - Nuovo Progetto</h1>
						<div id="imHeaderObjects"><div id="imHeader_imObjectTitle_01_wrapper" class="template-object-wrapper"><div id="imHeader_imObjectTitle_01"><span id ="imHeader_imObjectTitle_01_text" >Computer</span></div></div><div id="imHeader_imMenuObject_02_wrapper" class="template-object-wrapper"><!-- UNSEARCHABLE --><div id="imHeader_imMenuObject_02"><div id="imHeader_imMenuObject_02_container"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
...
Home Page		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths=",/OpenFIRE-PICON-ESP32/%0A/about-us.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
...
ABOUT US		</a>
	...
	</li><li class="imMnMnLast imPage" data-link-paths=",/OpenFIRE-PICON-ESP32/%0A/order-and-contacts.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="order-and-contacts.html">
ORDER AND CONTACTS		</a>
</div>
</div>
...
$(function () {$('#imStickyBar_imMenuObject_03_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0, subtimeout = 0, width = 'none', height = 'none';        var submenu = $this.children('ul').add($this.find('.multiple-column > ul'));    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         clearTimeout(timeout);        clearTimeout(subtimeout);        $this.children('.multiple-column').show(0);        submenu.stop(false, false);        if (width == 'none') {             width = submenu.width();        }        if (height == 'none') {            height = submenu.height();            submenu.css({ overflow : 'hidden', height: 0});        }        setTimeout(function () {         submenu.css({ overflow : 'hidden'}).fadeIn(1).animate({ height: height }, 300, null, function() {$(this).css('overflow', 'visible'); });        }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         timeout = setTimeout(function () {         submenu.stop(false, false);            submenu.css('overflow', 'hidden').animate({ height: 0 }, 300, null, function() {$(this).fadeOut(0); });            subtimeout = setTimeout(function () { $this.children('.multiple-column').hide(0); }, 300);        }, 250);    });});});
					...
					<footer id="imFooter">
						<div id="imFooterObjects"><div id="imFooter_imObjectTitle_01_wrapper" class="template-object-wrapper"><div id="imFooter_imObjectTitle_01"><span id ="imFooter_imObjectTitle_01_text" >Computer</span></div></div><div id="imFooter_imTextObject_02_wrapper" class="template-object-wrapper"><div id="imFooter_imTextObject_02">
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_02_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<span class="fs9lh1-5 cf1 ff1">LOREM IPSUM - </span><span class="fs9lh1-5 cf1 ff1">DOLOR SIT AMET, 12</span><div><span class="fs9lh1-5 cf1 ff1">12345 CONSECTETUR (ADIPISCING)</span></div><div><span class="fs9lh1-5 cf1 ff1">+00 012 345 678</span><br></div><div><span class="fs9lh1-5 cf1 ff1">+00 012 345 678 (FAX)</span></div><div><span class="fs9lh1-5 cf1 ff1">INFO@EXAMPLE.COM</span><br></div>
		</div>
	</div>

</div>
</div><div id="imFooter_pluginAppObj_03_wrapper" class="template-object-wrapper"><!-- Social Icons v.14 --><div id="imFooter_pluginAppObj_03">
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_04_tab0" style="opacity: 1; ">
		<div class="text-inner">
			<div class="imTACenter"><span class="fs9lh1-5 cf1 ff1">Created with WebSite X5</span></div>
		</div>
	</div>
...
<div id="imObjectForm_5_3">Lorem ipsum dolor sit amiet adspicitur iubeque dolornt et </div></div>
</div>
			</div>
		</fieldset>
		<fieldset>
